          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 mb-10 max-w-2xl mx-auto">
                ...
                with powerful collaboration tools and end-to-end security.
              </p>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="p-6 border rounded-xl hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  ...
                  end-to-end encrypted chat keep your data secure.
                </p>
              </div>
              ...
              <div className="p-6 border rounded-xl hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  ...
                  allocation with comprehensive dashboards and reports.
                </p>
              </div>
              ...
              <div className="p-6 border rounded-xl hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  ...
                  assignments, comments, mentions, and approaching deadlines.
                </p>
              </div>
            </div>
          </div>
